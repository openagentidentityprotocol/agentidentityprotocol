# Contributing to the Agent Identity Protocol (OAIP)

Thank you for your interest in contributing to OAIP. This project aims to establish a zero-trust identity standard for autonomous AI agents.
