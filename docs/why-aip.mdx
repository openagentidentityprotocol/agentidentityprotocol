---
title: "Why AIP? The Problem with AI Agent Security"
---
...
- **Read the specification**: [AIP-v1alpha3 Specs](specs/aip-v1alpha3)
- **Try the reference implementation**: [AIP Go Implementation](https://github.com/openagentidentityprotocol/aip-go)
- **Write your first policy**: [Policy Reference](layer-2-enforcement/policy-reference)
