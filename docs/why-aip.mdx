...
- **Try the reference implementation**: [Go Proxy Implementation](https://github.com/openagentidentityprotocol/aip-go)
- **Write your first policy**: [Policy Reference](layer-2-enforcement/policy-reference.mdx)
